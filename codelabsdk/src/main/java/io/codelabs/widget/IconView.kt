...
class IconView @JvmOverloads constructor(
		...
		@StyleRes defStyleRes: Int = R.style.Widget_Plaid_IconView)
	...
	init {
		...
		constantShadowTranslationY = a.getDimension(R.styleable.IconView_constantShadowTranslationY,
				constantShadowTranslationY)
		variableShadowTranslationY = a.getDimension(R.styleable.IconView_variableShadowTranslationY,
	...
	private fun createShadow(bitmap: Bitmap?, canvas: Canvas, blurRadius: Float) {
		...
		canvas.translate(padding - iconBounds.left.toFloat(),
